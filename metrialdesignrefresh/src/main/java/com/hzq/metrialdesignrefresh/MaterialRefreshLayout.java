...
public class MaterialRefreshLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defstyleAttr) {
        ...
        textType = t.getInt(R.styleable.MaterialRefreshLayout_refresh_progress_text_visibility, 1);
        progressTextColor = t.getColor(R.styleable.MaterialRefreshLayout_refresh_progress_text_color, Color.BLACK);
    ...
    public void setFoodView1(final View headerView) {
        post(new Runnable() {
            @Override
            public void run() {
                materialFoodView.setTextType(1);
            }
        });
    }
